...
class FollowerController extends Controller
{
  ...
  public function followers(Request $request, $user_id) {
    ...
    if ($user) {
      $users = $user->followers()->orderBy('followables.created_at', 'DESC')->get();
      ...
      return response()->json([
        ...
        'meta'      => [
            'total' => $total,
            'following' => $current->isFollowing($user),
        ],
        'followers'     => $this->userSerializer->list($users, ['basic', 'followable']),
      ]);
    }
  ...
  public function followings(Request $request, $user_id) {
    ...
    if ($user) {
      $users = $user->followings()->orderBy('followables.created_at', 'DESC')->get();
