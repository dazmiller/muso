...
return [
    ...
    */
    ...
    'facebook_secret'   => env('JWT_FACEBOOK_SECRET', 'SomeRandomString'),
    'twitter_key'       => env('JWT_TWITTER_KEY', 'SomeRandomString'),
    'twitter_secret'    => env('JWT_TWITTER_SECRET', 'SomeRandomString'),
